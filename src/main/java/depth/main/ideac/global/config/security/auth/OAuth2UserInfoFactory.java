package com.sample.global.config.security.auth;

import java.util.Map;

import com.sample.global.DefaultAssert;
import com.sample.global.config.security.auth.company.Facebook;
import com.sample.global.config.security.auth.company.Github;
import com.sample.global.config.security.auth.company.Google;
import com.sample.global.config.security.auth.company.Kakao;
import com.sample.global.config.security.auth.company.Naver;
