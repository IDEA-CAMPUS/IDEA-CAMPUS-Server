    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/project", "/api/project/views", "/api/project/keyword","/api/project/{project-id}")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/idea", "/api/idea/views","/api/idea/{id}")
                        .permitAll()
